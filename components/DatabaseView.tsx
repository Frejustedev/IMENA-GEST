...
export const DatabaseView: React.FC<DatabaseViewProps> = ({ allPatients, roomsConfig, onViewPatientDetail }) => {
            ...
            <table className="min-w-full divide-y divide-slate-200">
                ...
                <tbody className="bg-white divide-y divide-slate-100">
                    {paginatedData.map(patient => (
                        <tr key={patient.id} onClick={() => onViewPatientDetail(patient)} className="hover:bg-sky-50 cursor-pointer">
